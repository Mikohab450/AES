...
namespace AES
{
    ...
    /*f*/  {0x17, 0x2b, 0x04, 0x7e, 0xba, 0x77, 0xd6, 0x26, 0xe1, 0x69, 0x14, 0x63, 0x55, 0x21, 0x0c, 0x7d} };
        ...
        {
            this.keyScheduleArray = new byte[60, 4];  // 4 columns of bytes corresponds to a word
            ...
            {
                temp[0] = this.keyScheduleArray[row - 1, 0]; temp[1] = this.keyScheduleArray[row - 1, 1];
                temp[2] = this.keyScheduleArray[row - 1, 2]; temp[3] = this.keyScheduleArray[row - 1, 3];
                ...
                this.keyScheduleArray[row, 0] = (byte)((int)this.keyScheduleArray[row - 8, 0] ^ (int)temp[0]);
                this.keyScheduleArray[row, 1] = (byte)((int)this.keyScheduleArray[row - 8, 1] ^ (int)temp[1]);
